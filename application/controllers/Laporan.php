...
class Laporan extends CI_Controller {
	...
	public function cetak_barang_keluar()
	{
		...
		if($this->input->post('filter')){
	        ...
	        //$html_content = $this->load->view('laporan/cetak_barang_keluar', $data, true);
