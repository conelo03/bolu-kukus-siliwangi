            ...
            <form action="<?= base_url('tambah-barang'); ?>" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="harga_jual_go_food" class="form-control" value="<?= set_value('harga_jual_go_food'); ?>" required="">
                  <?= form_error('harga_jual_go_food', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Harga Jual (Grab Food)</label>
                  <input type="number" name="harga_jual_grab_food" class="form-control" value="<?= set_value('harga_jual_grab_food'); ?>" required="">
                  <?= form_error('harga_jual_grab_food', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Harga Jual (Shopee Food)</label>
                  <input type="number" name="harga_jual_shopee_food" class="form-control" value="<?= set_value('harga_jual_shopee_food'); ?>" required="">
